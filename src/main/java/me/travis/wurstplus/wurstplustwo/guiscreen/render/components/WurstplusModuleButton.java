...
public class WurstplusModuleButton {
    ...
    public WurstplusModuleButton(WurstplusHack module, WurstplusFrame master) {
        ...
        this.opened_height = this.height = this.font.get_string_height();
        this.save_y = 0;
        this.opened = false;
    ...
    public void render(int mx, int my, int separe) {
        ...
        for (WurstplusAbstractWidget widgets : this.widget) {
            boolean is_passing_in_widget;
            widgets.set_x(this.get_x());
            boolean bl = is_passing_in_widget = this.opened ? widgets.motion_pass(mx, my) : false;
