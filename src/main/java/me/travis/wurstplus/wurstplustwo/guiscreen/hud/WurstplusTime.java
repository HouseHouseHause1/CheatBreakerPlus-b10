...
extends WurstplusPinnable {
    ...
    public void render() {
        ...
        String line = "";
        line = line + (WurstplusTimeUtil.get_hour() < 10 ? "0" + WurstplusTimeUtil.get_hour() : Integer.valueOf(WurstplusTimeUtil.get_hour()));
        line = line + ":";
        line = line + (WurstplusTimeUtil.get_minuite() < 10 ? "0" + WurstplusTimeUtil.get_minuite() : Integer.valueOf(WurstplusTimeUtil.get_minuite()));
        line = line + ":";
        line = line + (WurstplusTimeUtil.get_second() < 10 ? "0" + WurstplusTimeUtil.get_second() : Integer.valueOf(WurstplusTimeUtil.get_second()));
