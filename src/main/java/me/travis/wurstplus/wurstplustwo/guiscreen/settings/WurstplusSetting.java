...
public class WurstplusSetting {
    ...
    public void set_value(double value) {
        this.slider = value >= this.get_max(value) ? this.get_max(value) : (value <= this.get_min(value) ? this.get_min(value) : value);
    }

    public void set_value(int value) {
        this.slider = value >= this.get_max(value) ? (double)this.get_max(value) : (value <= this.get_min(value) ? (double)this.get_min(value) : (double)value);
    }
