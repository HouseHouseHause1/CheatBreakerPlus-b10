        ...
        if (message.length == 2) {
            if (message[1].equalsIgnoreCase("list")) {
                if (WurstplusFriendUtil.friends.isEmpty()) {
                    ...
                    for (WurstplusFriendUtil.Friend friend2 : WurstplusFriendUtil.friends) {
                        WurstplusMessageUtil.send_client_message("" + green + bold + friend2.getUsername());
                    }
                }
                return true;
            }
