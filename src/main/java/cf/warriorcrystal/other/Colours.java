...
public class Colours {
    ...
    public static int toRGBA(double r, double g, double b, double a) {
        return Colours.toRGBA((float)r, (float)g, (float)b, (float)a);
    }
    ...
    public static int toRGBA(float r, float g, float b, float a) {
        return Colours.toRGBA((int)(r * 255.0f), (int)(g * 255.0f), (int)(b * 255.0f), (int)(a * 255.0f));
    }
    ...
    public static int toRGBA(float[] colors) {
        ...
        return Colours.toRGBA(colors[0], colors[1], colors[2], colors[3]);
    }
    ...
    public static int toRGBA(double[] colors) {
        ...
        return Colours.toRGBA((float)colors[0], (float)colors[1], (float)colors[2], (float)colors[3]);
    }
    ...
    public static class Colors {
        public static final int WHITE = Colours.toRGBA(255, 255, 255, 255);
        public static final int BLACK = Colours.toRGBA(0, 0, 0, 255);
        public static final int RED = Colours.toRGBA(255, 0, 0, 255);
        public static final int GREEN = Colours.toRGBA(0, 255, 0, 255);
        public static final int BLUE = Colours.toRGBA(0, 0, 255, 255);
        public static final int ORANGE = Colours.toRGBA(255, 128, 0, 255);
        public static final int PURPLE = Colours.toRGBA(163, 73, 163, 255);
        public static final int GRAY = Colours.toRGBA(127, 127, 127, 255);
        public static final int DARK_RED = Colours.toRGBA(64, 0, 0, 255);
        public static final int YELLOW = Colours.toRGBA(255, 255, 0, 255);
